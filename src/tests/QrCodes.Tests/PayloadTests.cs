...
public partial class PayloadTests
{
    ...
    //    var generator = new RussiaPaymentOrder(name, account, bankName, bic, correspAcc);

    //    generator
    //        .ToString()
    //        .Should().Be($"ST00012|Name={name}|PersonalAcc={account}|BankName={bankName}|BIC={bic}|CorrespAcc={correspAcc}|");
    //}
    ...
    //    var name = "ООО «Три кита»";
    //    var correspAcc = "30101810965770000413";
    //    var generator = new RussiaPaymentOrder(name, account, bankName, bic, correspAcc, null, RussiaPaymentOrder.CharacterSets.windows_1251);
    ...
    //    var name = "ООО «Три кита»";
    //    var correspAcc = "30101810965770000413";
    //    var generator = new RussiaPaymentOrder(name, account, bankName, bic, correspAcc, null, RussiaPaymentOrder.CharacterSets.koi8_r);
    ...
    //    Assert.IsType<RussiaPaymentOrder.RussiaPaymentOrderException>(exception);
    //    exception.Message.Should().Be("No valid separator found.");
    //}
    ...
    //    var correspAcc = "30101810400000000225";
    //    var optionalFields = new RussiaPaymentOrder.OptionalFields()
    //    {
    ...
    //        Sum = "125000"
    //    };
    //    var generator = new RussiaPaymentOrder(name, account, bankName, bic, correspAcc, optionalFields);
    ...
    //    var exception = Record.Exception(() => new RussiaPaymentOrder(name, account, bankName, bic, correspAcc));
    //    Assert.NotNull(exception);
    //    Assert.IsType<RussiaPaymentOrder.RussiaPaymentOrderException>(exception);
    //    exception.Message.Should().Be($"The input for 'PersonalAcc' must not be null.");
    //}
    ...
    //    Assert.NotNull(exception);
    //    Assert.IsType<RussiaPaymentOrder.RussiaPaymentOrderException>(exception);
    //    exception.Message.Should().Be("The input for 'BIC' (abcd) doesn't match the pattern ^\\d{9}$");
    //}
    ...
    //    generator
    //        .ToString()
    //        .Should().Be($"ST00012|Name={name}|PersonalAcc={account}|BankName={bankName}|BIC={bic}|CorrespAcc={correspAcc}|Sum={optionalFields.Sum}|LastName={optionalFields.LastName}|FirstName={optionalFields.FirstName}|");
    //}
    ...
    //    generator
    //        .ToString()
    //        .Should().Be($"ST00012|Name={name}|PersonalAcc={account}|BankName={bankName}|BIC={bic}|CorrespAcc={correspAcc}|Sum={optionalFields.Sum}|CBC=CBC1|LastName=Hann|FirstName=R|MiddleName=C|Contract=99|ChildFio=J Doe|BirthDate=01.01.1990|Category=1|ClassNum=1|AddAmount=10|");
    //}
    ...
    //    generator
    //        .ToString()
    //        .Should().Be($"ST00012|Name={name}|PersonalAcc={account}|BankName={bankName}|BIC={bic}|CorrespAcc={correspAcc}|DrawerStatus=D1|KPP=KPP1|OKTMO=112233|DocNo=11|DocDate=08.11.2021|DocIdx=A1|Flat=5a|CounterId=1234|CounterVal=9999|InstNum=987|ExecId=77|");
    //}
    ...
    //    generator
    //        .ToString()
    //        .Should().Be($"ST00012|Name={name}|PersonalAcc={account}|BankName={bankName}|BIC={bic}|CorrespAcc={correspAcc}|PayeeINN=INN1|PayerINN=INN2|PaytReason=01|PayerAddress=Street 1, 123 City|PensAcc=SNILS_NO|PayerIdType=X|PayerIdNum=555|PaymTerm=A|PaymPeriod=12|");
    //}
    ...
    //    generator
    //        .ToString()
    //        .Should().Be($"ST00012|Name={name}|PersonalAcc={account}|BankName={bankName}|BIC={bic}|CorrespAcc={correspAcc}|Purpose=Test|PersonalAccount=3333|PersAcc=2222|Phone=0012345|ServiceName=Bank|QuittId=7|QuittDate=01.02.2021|RuleId=2|RegType=y|");
    //}
    ...
    //        TaxPaytKind = "99",
    //        TaxPeriod = "31",
    //        TechCode = RussiaPaymentOrder.TechCode.ГИБДД_налоги_пошлины_бюджетные_платежи,
    //        UIN = "1a2b"
    //    };
    ...
    //    generator
    //        .ToString()
    //        .Should().Be($"ST00012|Name={name}|PersonalAcc={account}|BankName={bankName}|BIC={bic}|CorrespAcc={correspAcc}|TaxPeriod=31|TaxPaytKind=99|SpecFio=T. Eacher|UIN=1a2b|TechCode=ГИБДД_налоги_пошлины_бюджетные_платежи|");
    //}
}